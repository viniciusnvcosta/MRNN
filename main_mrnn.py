...
if __name__ == "__main__":
    ...
    parser.add_argument("--file_name", default="data/google.csv", type=str)
    parser.add_argument(
        "--seq_len", help="sequence length of time-series data", default=7, type=int
    )
    parser.add_argument(
        "--missing_rate",
    ...
    parser.add_argument(
        "--iteration", help="the number of iteration", default=2000, type=int
    )
    parser.add_argument(
        "--learning_rate",
    ...
    parser.add_argument(
        "--metric_name", help="imputation performance metric", default="rmse", type=str
    )
